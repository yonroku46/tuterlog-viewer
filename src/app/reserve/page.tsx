...
const CLASSES: ClassInfo[] = [
  { classId: '1', startTime: '09:00', endTime: '09:50', name: '리포머 필라테스 A', instructor: '이은주 강사', room: 'Room 1', reserved: 7, capacity: 10, image: 'https://images.unsplash.com/photo-1518611012118-296072bb56ec?w=100&h=100&fit=crop' },
  { classId: '2', startTime: '10:00', endTime: '10:50', name: '캐딜락 & 체어', instructor: '김미나 강사', room: 'Room 2', reserved: 10, capacity: 10, waitlist: 4, image: 'https://images.unsplash.com/photo-1518459031867-a89b944bffe4?w=100&h=100&fit=crop' },
  { classId: '3', startTime: '11:00', endTime: '11:50', name: '리포머 필라테스 B', instructor: '이은주 강사', room: 'Room 1', reserved: 4, capacity: 10, image: 'https://images.unsplash.com/photo-1518611012118-296072bb56ec?w=100&h=100&fit=crop' },
  { classId: '4', startTime: '14:00', endTime: '14:50', name: '체어 & 바렐', instructor: '박서영 강사', room: 'Room 3', reserved: 8, capacity: 10, image: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=100&h=100&fit=crop' },
  { classId: '5', startTime: '16:00', endTime: '16:50', name: '리포머 필라테스 C', instructor: '김미나 강사', room: 'Room 1', reserved: 6, capacity: 10, image: 'https://images.unsplash.com/photo-1518611012118-296072bb56ec?w=100&h=100&fit=crop' },
  { classId: '6', startTime: '19:00', endTime: '19:50', name: '리포머 야간 A', instructor: '이은주 강사', room: 'Room 1', reserved: 9, capacity: 10, image: 'https://images.unsplash.com/photo-1518611012118-296072bb56ec?w=100&h=100&fit=crop' },
  { classId: '7', startTime: '20:00', endTime: '20:50', name: '캐딜락 야간 B', instructor: '박서영 강사', room: 'Room 2', reserved: 10, capacity: 10, waitlist: 2, image: 'https://images.unsplash.com/photo-1518459031867-a89b944bffe4?w=100&h=100&fit=crop' },
  { classId: '8', startTime: '21:00', endTime: '21:50', name: '파워 필라테스', instructor: '김미나 강사', room: 'Room 3', reserved: 5, capacity: 10, image: 'https://images.unsplash.com/photo-1518310383802-640c2de311b2?w=100&h=100&fit=crop' },
];
              ...
              <div className="class-card">
                <div className="class-info">
                  ...
                  <div className="class-footer">
                    <span className="instructor">{cls.instructor}</span>
          ...
          <div className="class-detail-view">
            <div className="detail-header">
              ...
              <div className="info-box">
                ...
                <p className="instructor">{selectedClass.instructor}</p>
              </div>
            </div>
            ...
            <div className="notice-box">
              ...
              <ul>
                ...
                <li>당일 취소는 수업 4시간 전까지 가능합니다.</li>
                <li>노쇼 발생 시 이용권이 차감될 수 있습니다.</li>
              </ul>
            </div>
          </div>
        )}
